"""review-ui (master plan Phase 7) — human approve/reject of loss hypotheses.
...
(`incidents.summary`, which the evidence-builder writes as JSON). We do NOT edit
...
def get_incident(incident_id: str):
    ...
    evidence-builder stored in `incidents.summary` (JSON). We still fetch the
