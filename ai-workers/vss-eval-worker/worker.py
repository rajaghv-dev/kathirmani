"""vss-eval-worker CLI (master plan Phase 9 — VSS-style OSS parity).
...
if __name__ == "__main__":
    import argparse
    ap = argparse.ArgumentParser(description="vss-eval-worker (Phase 9)")
    ...
    if args.cmd == "summarize":
        ...
        print(f"[vss-eval-worker] parity report -> {args.out}")
